...
public class MainActivity extends Activity {
	...
	public void showNotification() {
		...
		.setContentTitle("New Notification")
				.setContentText("You have a new notification, click to view")
				.setSmallIcon(R.drawable.smiley).setContentIntent(pIntent)
				.setSound(soundUri)

				.addAction(R.drawable.smiley, "View", pIntent)
				.addAction(0, "Later", pIntent)
