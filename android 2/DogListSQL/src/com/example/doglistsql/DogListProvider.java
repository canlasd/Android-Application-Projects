...
public class DogListProvider extends ContentProvider {

	public static final String PROVIDER_NAME = "AND001.sqlitedoglist.dog";
	...
	public boolean onCreate() {
		mDogsDB = new DogListDB(getContext());
		return true;
	}
