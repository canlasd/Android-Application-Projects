...
/**
 * Since this class attaches the dialog fragment "AlertDialogRadio", it is
 * supposed to implement the interface "AlertPositiveListener"
 */
public class MainActivity extends Activity implements AlertPositiveListener {
	...
	/**
	 * Defining button click listener for the Choose Puppy button of the alert
	 * dialog window
	 */
	@Override
	public void onPositiveClick(int position) {
		...
		tv.setText("Awww a: " + Android.Dogs[this.position]);
	}
}